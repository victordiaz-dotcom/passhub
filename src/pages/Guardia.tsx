        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
          {visits.map((visit) => (
            ...
            >
              ...
              <p className="line-clamp-2 text-sm font-medium text-ink">{visit.visitor_name}</p>
          ...
          <div className="mx-auto max-w-md p-4">
              ...
              <div>
                ...
                <div className="flex aspect-square w-full items-center justify-center overflow-hidden rounded-lg border border-line bg-card">
                  {photoUrls[selectedVisit.id] ? (
                    ...
                    <span className="text-sm text-ink-soft">Sin foto</span>
                  )}
                </div>
              </div>
            ...
            <dl className="mt-4 divide-y divide-line rounded-lg border border-line bg-card px-4 text-sm">
              ...
              <div className="flex justify-between py-3">
                ...
                <dd className="font-medium text-ink">{selectedVisit.companies?.name ?? "—"}</dd>
              </div>
              <div className="flex justify-between py-3">
                <dt className="text-ink-soft">A quién visita</dt>
                <dd className="font-medium text-ink">{selectedVisit.employees?.full_name ?? "—"}</dd>
              </div>
              <div className="flex justify-between py-3">
                <dt className="text-ink-soft">Día de entrada</dt>
                <dd className="font-medium text-ink">{formatDate(selectedVisit.check_in_at)}</dd>
              </div>
              <div className="flex justify-between py-3">
                <dt className="text-ink-soft">Hora de entrada</dt>
                <dd className="font-medium text-ink">{formatTime(selectedVisit.check_in_at)}</dd>
              </div>
            </dl>
          </div>
        </div>
